...
//           <button className="hover:scale-105 transition-transform px-4 py-2 text-white rounded bg-blue-500">
//             Register
//           </button>
//           <button className="hover:scale-105 transition-transform px-4 py-2 text-white rounded ml-4 bg-green-500">
//             Login
//           </button>
//         </div>
//       </nav>
